...
対象地域における導入率は 42% であったと報告されている。


前年比で 7 ポイントの増加であり、増加幅は過去最大である。


中小規模の事業者では導入率が 28% にとどまっている。


導入の障壁として初期費用を挙げた回答が 61% を占めた。


運用開始までの期間は平均 4.2 か月と報告されている。


満足度は5段階評価で平均 3.8 であったとされる。


## 考察

導入率と事業規模の関係は と の双方から読み取れる。
費用面の障壁は に、運用面の負荷は に対応する。
利用者側の評価は、経年の変化は が示している。
